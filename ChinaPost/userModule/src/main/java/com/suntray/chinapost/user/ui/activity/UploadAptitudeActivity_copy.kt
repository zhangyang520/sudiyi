...
//class UploadAptitudeActivity_copy:BaseMvpActivity<ClientPresenter>(),ClientView{
//
//
...
//        ToastUtil.makeText(this@UploadAptitudeActivity_copy,"上传成功")
//        finish()
//    }
//
...
//                //提示不能上传
//                ToastUtil.makeText(this@UploadAptitudeActivity_copy,error)
//                finish()
//            }
//        }
//    }
...
//        viewtitle="上传资质信息"
//
//        hud2= KProgressHUD(this@UploadAptitudeActivity_copy).setLabel("获取资质信息....").setStyle(KProgressHUD.Style.SPIN_INDETERMINATE)
...
//                        ))
//            }else{
//                ToastUtil.makeText(this@UploadAptitudeActivity_copy,"至少选择一种类型的图片")
//            }
//        })
//
//        //点击 取消按钮
...
//        yinyeAdapter = UploadImageAdapter(this@UploadAptitudeActivity_copy,yinyelist)
...
//                        } else {
//                        }
//                    }, Runnable { ToastUtil.makeText(this@UploadAptitudeActivity_copy, "读写存储卡权限未打开，请到手机权限中心设置打开...") })
//                }, Runnable { ToastUtil.makeText(this@UploadAptitudeActivity_copy, "相机权限未打开，请到手机权限中心设置打开...") })
//
//            }
//        })
//
...
//        //商标
//        tradeAdapter = UploadImageAdapter(this@UploadAptitudeActivity_copy, tradelist)
...
//        foodAdapter = UploadImageAdapter(this@UploadAptitudeActivity_copy, foodlist)
...
//        portraitAdpater = UploadImageAdapter(this@UploadAptitudeActivity_copy,portraitlist)
...
//
//        clienMianzeAdapter = UploadImageAdapter(this@UploadAptitudeActivity_copy, clientlist)
...
//        zCodeAdpater = UploadImageAdapter(this@UploadAptitudeActivity_copy,zcodelist)
...
//        expressAdapter = UploadImageAdapter(this@UploadAptitudeActivity_copy, expresslist)
...
//        otherAdapter = UploadImageAdapter(this@UploadAptitudeActivity_copy,otherlist)
...
//        hostAdpater = UploadImageAdapter(this@UploadAptitudeActivity_copy, hostlist)
...
//        dichanxiaoshouAdapter = UploadImageAdapter(this@UploadAptitudeActivity_copy, landlist)
...
//        //设置长按弹窗-提醒是否删除本条目
//        photoWindow= PopupWindow(this@UploadAptitudeActivity_copy)
//        var view=View.inflate(this@UploadAptitudeActivity_copy,R.layout.item_choose_photo,null)
...
//        return View.inflate(this@UploadAptitudeActivity_copy,R.layout.activity_upload_aptitude,null);
//    }
//
//
//    /**
...
//                crop(uri)
//            } else {
//                Toast.makeText(this@UploadAptitudeActivity_copy, "未找到存储卡，无法存储照片！", Toast.LENGTH_SHORT).show()
//            }
//
