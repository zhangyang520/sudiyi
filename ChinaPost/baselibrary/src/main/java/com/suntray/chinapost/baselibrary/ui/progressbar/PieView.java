...
import com.suntray.chinapost.baselibrary.ui.progressbar.Helper;
import com.suntray.chinapost.baselibrary.ui.progressbar.Determinate;
...
class PieView extends View implements Determinate {
    ...
    private void init(){
        ...
        mWhitePaint.setStrokeWidth(Helper.INSTANCE.dpToPixel(0.1f, getContext()));
        mWhitePaint.setColor(Color.WHITE);

        mGreyPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mGreyPaint.setStyle(Paint.Style.STROKE);
        mGreyPaint.setStrokeWidth(Helper.INSTANCE.dpToPixel(2, getContext()));
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        int padding = Helper.INSTANCE.dpToPixel(4, getContext());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int dimension = Helper.INSTANCE.dpToPixel(40, getContext());
