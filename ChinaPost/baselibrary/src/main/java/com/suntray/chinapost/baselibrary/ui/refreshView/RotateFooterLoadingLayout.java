package com.suntray.chinapost.baselibrary.ui.refreshView;
 ...
 * @since 2013-7-30
 */
public class RotateFooterLoadingLayout extends LoadingLayout{
    /**旋转动画的时间*/
     ...
     */
    public RotateFooterLoadingLayout(Context context) {
        super(context);
        init(context);
    }
     ...
     * @param attrs attrs
     */
    public RotateFooterLoadingLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
...
//        mHeaderTimeViewTitle = (TextView) findViewById(R.id.pull_to_refresh_last_update_time_text);
    	...
    	mArrowImageView = (ImageView) findViewById(R.id.pull_to_refresh_footer_arrow);
    	mHintTextView = (TextView) findViewById(R.id.pull_to_load_footer_hint_textview);
    ...
    protected View createLoadingView(Context context,AttributeSet attrs){
        View container = LayoutInflater.from(context).inflate(R.layout.pull_to_load_foote2, null);
        return container;
    }
