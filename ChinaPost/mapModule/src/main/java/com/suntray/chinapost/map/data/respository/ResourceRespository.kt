...
class ResourceRespository @Inject constructor(){
     ...
     *  获取上下看刊 的报告
     */
    fun getResourceReportRequest( findResourceReportRequest: FindResourceReportRequest):Observable<BaseResp<AdDownResponse>>{
        return  RetrofitFactory.instance.create(ResourceApi::class.java).getResourceReportRequest(findResourceReportRequest)
    }
