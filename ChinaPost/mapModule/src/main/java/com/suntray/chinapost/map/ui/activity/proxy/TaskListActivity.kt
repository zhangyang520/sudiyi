    ...
    override fun initView() {
        ...
        swipeBtnRelativeLayout.onRatingBarChangeListener=object: OnRatioChanageListener {
            override fun onChangeToLeft() {
                if(currentIndex!=0){
                    currentIndex=0
                    unFinishFragment!!.firstType=currentIndex
                    willExamineFragment!!.firstType=currentIndex
                    notExamineFragment!!.firstType=currentIndex
                    examineFragment!!.firstType=currentIndex
