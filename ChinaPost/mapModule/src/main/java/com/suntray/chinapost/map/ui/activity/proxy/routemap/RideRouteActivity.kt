 ...
 * 骑行路径规划功能的实现
 */
class RideRouteActivity : Activity(), OnMapClickListener, OnMarkerClickListener, OnInfoWindowClickListener, InfoWindowAdapter, OnRouteSearchListener {
    ...
    private fun registerListener() {
        aMap!!.setOnMapClickListener(this@RideRouteActivity)
        aMap!!.setOnMarkerClickListener(this@RideRouteActivity)
        aMap!!.setOnInfoWindowClickListener(this@RideRouteActivity)
        aMap!!.setInfoWindowAdapter(this@RideRouteActivity)
        ...
        if (errorCode == AMapException.CODE_AMAP_SUCCESS) {
            if (result != null && result.paths != null) {
                if (result.paths.size > 0) {
                    ...
                    val ridePath = mRideRouteResult!!.paths[0] ?: return
                    ...
                    mBottomLayout!!.setOnClickListener {
                        val intent = Intent(mContext,
                                RideRouteDetailActivity::class.java)
